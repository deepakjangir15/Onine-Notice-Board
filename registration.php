	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Working_out<input value="singin" type="checkbox" name="hob[]"/>
					Dancing<input value="singin" type="checkbox" name="hob[]"/>
					Travelling<input value="singin" type="checkbox" name="hob[]"/>
					Sports<input value="singin" type="checkbox" name="hob[]"/>
					Adventure<input value="playing" type="checkbox" name="hob[]"/>
					</td>
				</tr>
